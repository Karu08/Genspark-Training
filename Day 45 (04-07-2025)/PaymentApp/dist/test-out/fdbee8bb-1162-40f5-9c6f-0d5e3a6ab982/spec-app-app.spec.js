import {
  ...
  init_forms,
  init_payment_form
} from "./chunk-IOJD5FDT.js";
import {
  EVENT_MANAGER_PLUGINS,
  EventManagerPlugin,
  init_dom_renderer
} from "./chunk-NPQYIVIG.js";
import {
  BehaviorSubject,
  ChangeDetectorRef,
  Compiler,
...
var init_app = __esm({
  "angular:jit:template:src/app/app.html"() {
    app_default = "<app-payment-form></app-payment-form>\n";
  }
});
  ...
  "src/app/app.ts"() {
    ...
    App = __decorate([
      Component({
        selector: "app-root",
        standalone: true,
        imports: [RouterOutlet, ReactiveFormsModule, PaymentForm],
...
var require_app_spec = __commonJS({
  "src/app/app.spec.ts"(exports) {
    ...
    describe("App", () => {
      ...
      it("should render the payment form component", () => {
        const fixture = TestBed.createComponent(App);
        fixture.detectChanges();
        const compiled = fixture.nativeElement;
        expect(compiled.querySelector("app-payment-form")).toBeTruthy();
      });
    });
  }
});
