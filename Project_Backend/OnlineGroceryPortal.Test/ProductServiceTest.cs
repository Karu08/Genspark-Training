...
namespace OnlineGroceryPortal.Test
{
    ...
    public class ProductServiceTests
    {
        ...
        public async Task GetAllProductsAsync_ReturnsMappedProductDtos()
        {
            ...
            {
                new Product { Id = Guid.NewGuid(), ProdName = "Tomato", Price = 30 },
                new Product { Id = Guid.NewGuid(), ProdName = "Potato", Price = 40 }
            };
    ...
    {
        new Claim("http://schemas.microsoft.com/ws/2008/06/identity/claims/role", "Agent"),
    ...
    public class ProductControllerTests
    {
        ...
        public async Task GetAll_ReturnsOkWithProducts()
        {
            ...
            {
                new ProductDto { Id = Guid.NewGuid(), Name = "Tomato" },
                new ProductDto { Id = Guid.NewGuid(), Name = "Potato" }
            };
        ...
        {
            _mockService.Setup(s => s.GetProductByIdAsync(It.IsAny<Guid>())).ReturnsAsync((ProductDto?)null);
        ...
        public async Task Create_ReturnsCreatedAtAction()
        {
            ...
            var created = new ProductDto { Id = Guid.NewGuid(), Name = "Orange" };
